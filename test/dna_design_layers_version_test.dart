...
void main() {
  group('dna_design_layers_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/dna_design_layers_version.dart');
